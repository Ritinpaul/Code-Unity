...
export default function Room({ socket }) {
  ...
  return (
    <div className="room">
      <div className="roomSidebar fullWidth">
  <div className="roomSidebarUsersWrapper fullWidth">
    <div className="languageFieldWrapper fullWidth">
      <select className="languageField fullWidth" name="language" id="language" value={language} onChange={handleLanguageChange}>
    ...
    <div className="languageFieldWrapper fullWidth">
      <select className="languageField fullWidth" name="codeKeybinding" id="codeKeybinding" value={codeKeybinding} onChange={handleCodeKeybindingChange}>
    ...
    <p>Connected Users:</p>
    <div className="roomSidebarUsers fullWidth">
      {fetchedUsers.map((each) => (
        <div key={each} className="roomSidebarUsersEach fullWidth">
  ...
  <button className="roomSidebarCopyBtn fullWidth" onClick={() => { copyToClipboard(roomId) }}>Copy Room id</button>
  <button className="roomSidebarBtn fullWidth" onClick={() => { handleLeave() }}>Leave</button>
</div>
